...
import com.project.fisionettest.databinding.FragmentAdminPatientsBinding
import com.project.fisionettest.ui.home.PatientAdapter
...
class AdminPatientsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabAddPatient.setOnClickListener {
            findNavController().navigate(R.id.action_adminDashboard_to_addPatient)
        }
    ...
    private fun setupRecyclerView() {
        patientAdapter = PatientAdapter { patient ->
            patient.id?.let { id ->
                ...
                findNavController().navigate(R.id.action_adminDashboard_to_patientDetail, bundle)
            }
        }
    ...
    private fun applyFiltersAndSort() {
        ...
        list = when (currentSort) {
            "A-Z" -> list.sortedBy { it.name.lowercase(Locale.getDefault()) }
            "Z-A" -> list.sortedByDescending { it.name.lowercase(Locale.getDefault()) }
